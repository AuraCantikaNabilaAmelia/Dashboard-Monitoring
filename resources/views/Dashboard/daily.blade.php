        ...
        <div class="mt-6 glass dark:bg-slate-900/30 bg-white rounded-2xl px-6 py-4 border border-slate-200/50 dark:border-white/5 shadow-lg">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div class="flex gap-1">
                    ...
                    @if($daftarPenugasan->hasMorePages())
                        <a href="{{ $daftarPenugasan->appends(request()->query())->nextPageUrl() }}" class="px-4 py-2 rounded-lg bg-white dark:bg-white/10 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-500/10 hover:border-blue-300 dark:hover:border-blue-500/30 hover:text-blue-600 transition-all text-sm font-medium">Next</a>
                    @else
