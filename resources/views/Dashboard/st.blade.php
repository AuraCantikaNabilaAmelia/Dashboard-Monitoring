            ...
            <div class="flex flex-col lg:flex-row gap-4 items-end">
                ...
                <div class="flex items-end gap-2 flex-wrap">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('export.st.pdf', request()->query()) }}" class="h-12 px-5 bg-rose-50 dark:bg-rose-500/10 hover:bg-rose-100 dark:hover:bg-rose-500/20 text-rose-600 dark:text-rose-400 rounded-xl transition-all flex items-center justify-center border border-rose-200 dark:border-rose-500/20 group gap-2" title="Export PDF">
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-blue-50/50 dark:hover:bg-white/[0.02] transition-all group">
                        ...
                        <td class="px-6 py-5">
                            <div class="max-w-md">
                                <a href="{{ route('st.detail', $suratTugas->id_st) }}" class="group/link">
                                    <p class="text-sm font-bold text-slate-800 dark:text-slate-200 line-clamp-1 group-hover/link:text-blue-600 transition-colors" title="{{ $suratTugas->nama_penugasan }}">
                                        {{ $suratTugas->nama_penugasan }}
                                    </p>
                                    <span class="text-[10px] font-mono font-bold text-slate-400 group-hover/link:text-blue-400/70 transition-colors">{{ $suratTugas->nomor_lhp ?? 'Belum ada LHP' }}</span>
                                </a>
                            </div>
                        </td>
                        <td class="px-6 py-5">
