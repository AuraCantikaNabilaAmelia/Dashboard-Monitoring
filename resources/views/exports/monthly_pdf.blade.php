...
<html>
<head>
    <title>Rekap Penugasan Bulanan</title>
    <style>
        @page { margin: 1.5cm; }
...
<body>
    ...
    <div class="doc-header">
        <div class="doc-title">REKAP PENUGASAN PEGAWAI (BULANAN)</div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="150" class="center">Total Penugasan</th>
            </tr>
        </thead>
        <tbody>
            @foreach($rekapPenugasanBulanan as $index => $pegawai)
            <tr>
                <td class="center">{{ $index + 1 }}</td>
                <td class="bold">{{ $pegawai->nama }}</td>
                <td class="center font-mono">{{ $pegawai->nip }}</td>
                <td class="center bold highlight">{{ $pegawai->total }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
